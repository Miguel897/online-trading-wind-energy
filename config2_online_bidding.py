...
class Setting:
    ...
    # Test
    # test_start = datetime.datetime.strptime('2015-12-31', '%Y-%m-%d')
    # test_end = datetime.datetime.strptime('2021-06-05', '%Y-%m-%d') # Not included
    # test_end = datetime.datetime.strptime('2022-01-01', '%Y-%m-%d') # Not included
    # Old
    # test_end = datetime.datetime.strptime('2018-12-31', '%Y-%m-%d')
    # test_end = datetime.datetime.strptime('2017-01-01', '%Y-%m-%d')
    # test_end = datetime.datetime.strptime('2016-07-01', '%Y-%m-%d')
    #
    ...
    # alpha: float = 0.02
    # alpha: float = 10
    # teta: float = 5e-2  # Regularization
    # teta: float = 5e-3  # Regularization
    # teta: float = 1e-2  # Regularization
    # teta: float = 1e-1  # Regularization
    teta: float = 0  # Original
    # mu: float = .3
    mu: float = 0.8  # Original
    # mu: float = 0.7
    # mu: float = 1.0
    # mu: float = 0.7
    # mu: float = 0.5
